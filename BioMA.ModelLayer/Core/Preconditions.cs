namespace CRA.ModelLayer.Core
{
    ...
    public class Preconditions
    {
        ...
        public void TestsOut(
            ITestsOutput writer,
            string testResult, bool saveLog, string componentName)
        {
            new TestPreconditions().TestsOut(
                writer,
                testResult, saveLog, componentName);
        }

        public void TestsOut(string testResult, bool saveLog, string componentName)
        {
        new TestPreconditions().TestsOut(null, testResult, saveLog, componentName);
        }
