...
namespace CRA.Clima.SolarR.Strategies
{
	...
	public class HPBDSupitVanDerGroot: IRadDataStrategy
    {
        ...
        private readonly string _strategyName = "HPBDSupitVanDerGroot";
		...
		/// <summary>Parameter of the HPBDSupitVanDerGroot model</summary>
		...
		/// <summary>VarInfo of parameter of the HPBDSupitVanDerGroot model</summary>
		...
		private string PreConditions( RadData rd, string callID)
		{
            ...
            GreaterThanCondition g = new GreaterThanCondition(RadDataVarInfo.GlobalSolarRadiation, RadDataVarInfo.RadiationDiffuseSky);
