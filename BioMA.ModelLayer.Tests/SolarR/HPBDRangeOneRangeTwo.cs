...
namespace CRA.Clima.SolarR.Strategies
{
	...
	public class HPBDRangeOneRangeTwo : IRadDataStrategy
    {
        ...
        private readonly string _strategyName = "HPBDRangeOneRangeTwo";
        ...
        /// <summary>Parameter of the HPBDRangeOneRangeTwo model</summary>
        ...
        /// <summary>VarInfo of parameter of the HPBDRangeOneRangeTwo model</summary>
		...
		private string PreConditions( RadData rd, string callID)
		{
            ...
            RangeOneRangeTwoCondition g = new RangeOneRangeTwoCondition(RadDataVarInfo.GlobalSolarRadiation, RadDataVarInfo.RadiationDiffuseSky);
